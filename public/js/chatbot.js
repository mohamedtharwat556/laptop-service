...
(function () {
    ...
    const KB = [
...

        {
            ...
            replies: [
                '📞 نحن متواجدون لمساعدتك:\n\n• الاتصال بنا هاتفياً: **0106943785**\n• <a href="https://wa.me/20106943785" target="_blank" class="chat-link">💬 اضغط هنا للدردشة المباشرة عبر واتساب</a>'
            ]
        },
        {
    ...
    const DEFAULT_REPLIES = [
        ...
        '💭 عذراً، لم أستوعب المشكلة بدقة. يمكنك التواصل مباشرة مع فني الصيانة على 0106943785'
    ];
