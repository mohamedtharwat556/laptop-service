...
(function () {
    ...
    const KB = [
        ...
        },
        {
            ...
            replies: [
                '🔧 لتقديم طلب صيانة وحجز موعد، يرجى الضغط هنا:\n<a href="customer.html" class="chat-link">📋 نموذج تقديم طلب صيانة</a>\n\nأو تواصل معنا لتأكيد الحجز فوراً:\n📞 <a href="tel:+201069143785" class="chat-link">+20 10 69143785</a>\n💬 <a href="https://wa.me/201069143785" target="_blank" class="chat-link">تواصل عبر واتساب</a>'
            ]
        },
        {
        ...
        },
        {
            ...
            replies: [
                '⭐ فخورون جداً بأن **نسبة رضا عملائنا هي 99%**! نسعى دائماً لتقديم الخدمة بأعلى جودة مع ضمان يختلف حسب حالة اللاب ونوع الإصلاح لضمان راحتك.'
            ]
        },
        {
    ...
    const DEFAULT_REPLIES = [
        ...
        '💭 عذراً، لم أستوعب المشكلة بدقة. يمكنك التواصل مباشرة مع فني الصيانة على <a href="tel:+201069143785" class="chat-link">+20 10 69143785</a>'
    ];
