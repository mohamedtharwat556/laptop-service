...
router.get('/', async (req, res) => {
    try {
        console.log('// GET /api/company-requests - Get all company requests');
...
router.post('/', async (req, res) => {
    try {
        ...
        const newRequest = {
            ...
            company_email: req.body.companyEmail || null,
            commercial_register: req.body.commercialRegister || null,
            contact_person: req.body.contactPerson || null,
            contact_person_phone: req.body.contactPersonPhone || null,
